...
FaceIT-style ranked tracking for Counter-Strike 2. Sign up with email, link Steam once, download the Windows client, and play — match stats and Elo update automatically each season.
...
- Steam linked once during signup (permanent — no relinking)
- Sign in with email/password or Steam
...
1. Sign up with email and password, then link Steam
2. Verify your email when ready to play ranked
